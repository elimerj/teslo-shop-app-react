...
export const AdminProductForm = ({
  ...
  const addSize = (size: Size) => {
    sizeSet.add(size);
    setValue('sizes', Array.from(sizeSet)); //Agregamos las sizes al formulario transformándolo en un array desde un set
  };
                  ...
                  {availableSizes.map((size) => (
                    <span
                      ...
                      className={cn(
                        ...
                        {
                          hidden: !selectedSizes.includes(size), // 'hidden': !selectedSizes.includes(size);
                        }
                      )}
                    >
                      {size}
